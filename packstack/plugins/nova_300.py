    ...
    nova_params = {
            "NOVA" : [
                  ...
                  {"CMD_OPTION"      : "novasched-ram-allocation-ratio",
                   ...
                   "NEED_CONFIRM"    : False,
                   "CONDITION"       : False },
                  {"CMD_OPTION"      : "nova-rpc-backend",
                   "USAGE"           : "Nova RPC backend",
                   "PROMPT"          : "Enter the Nova RPC backend",
                   "OPTION_LIST"     : [r'^nova\.openstack\.common\.rpc\.impl_\w+$'],
                   "VALIDATORS"      : [validators.validate_regexp],
                   "DEFAULT_VALUE"   : "nova.openstack.common.rpc.impl_qpid",
                   "MASK_INPUT"      : False,
                   "LOOSE_VALIDATION": True,
                   "CONF_NAME"       : "CONFIG_NOVA_RPC_BACKEND",
                   "USE_DEFAULT"     : False,
                   "NEED_CONFIRM"    : False,
                   "CONDITION"       : False },
                  ],
