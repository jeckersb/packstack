    ...
    conf_params = {
        "NEUTRON" : [
            ...
            {"CMD_OPTION"      : "neutron-metadata-pw",
             ...
             "NEED_CONFIRM"    : True,
             "CONDITION"       : False },
            {"CMD_OPTION"      : "neutron-rpc-backend",
             "USAGE"           : "Neutron RPC backend",
             "PROMPT"          : "Enter the Neutron RPC backend",
             "OPTION_LIST"     : [r'^neutron\.openstack\.common\.rpc\.impl_\w+$'],
             "VALIDATORS"      : [validators.validate_regexp],
             "DEFAULT_VALUE"   : "neutron.openstack.common.rpc.impl_qpid",
             "MASK_INPUT"      : False,
             "LOOSE_VALIDATION": True,
             "CONF_NAME"       : "CONFIG_NEUTRON_RPC_BACKEND",
             "USE_DEFAULT"     : False,
             "NEED_CONFIRM"    : False,
             "CONDITION"       : False },
            ],
