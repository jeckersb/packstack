...
def initConfig(controllerObject):
    ...
    parameters = [
        ...
        {"CMD_OPTION"      : "heat-rpc-backend",
         "USAGE"           : "Heat RPC backend",
         "PROMPT"          : "Enter the Heat RPC backend",
         "OPTION_LIST"     : [r'^heat\.openstack\.common\.rpc\.impl_\w+$'],
         "VALIDATORS"      : [validators.validate_regexp],
         "DEFAULT_VALUE"   : "heat.openstack.common.rpc.impl_qpid",
         "MASK_INPUT"      : False,
         "LOOSE_VALIDATION": True,
         "CONF_NAME"       : "CONFIG_HEAT_RPC_BACKEND",
         "USE_DEFAULT"     : False,
         "NEED_CONFIRM"    : False,
         "CONDITION"       : False },
        ]
